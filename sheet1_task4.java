...
public class task4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("4: "+ (a++^b));			// Ausgabe 45, da genauso wie 3 denn a wird erst im nachhinein erhöht
		System.out.println("5: "+ (7<<++c));		// Ausgabe 28 0 11100, da 7 = 111 bitweise um zwei nach links verschoben wird
		System.out.println("6: "+ (a=b=c=0x10));	// Ausgabe 16, da 10 in Hexadezimal gleich 16 ist und Wertzuweisungen den Wert zurückgeben
